...
img_dir = '//users/cmenghin/data/bats/datasets/CUB_200_2011/CUB_200_2011/images/'#os.path.join(NFS_path,'data/CUB/')
mat_path = f'/users/cmenghin/data/bats/projects/adversarial/adversarial_grid/zsl_methods/models/xlsa17/data/CUB/res101.mat'
#os.path.join(NFS_path,'data/xlsa17/data/CUB/res101.mat')
