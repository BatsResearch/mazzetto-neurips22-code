...
img_dir = '../../data/aPY/images/'#os.path.join(NFS_path,'data/{}/'.format(dataset))
mat_path = '../xlsa17/data/APY/res101.mat'#os.path.join(NFS_path,'data/xlsa17/data/{}/res101.mat'.format(dataset))
split_path = '../xlsa17/data/APY/att_splits.mat'
