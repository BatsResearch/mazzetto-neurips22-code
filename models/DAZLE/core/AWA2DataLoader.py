...
#%%
dataset = 'AWA2'
img_dir = '../../data/AwA2/images/'#os.path.join(NFS_path,'data/{}/'.format(dataset))
mat_path = '../xlsa17/data/{}/res101.mat'.format(dataset)#os.path.join(NFS_path,'data/xlsa17/data/{}/res101.mat'.format(dataset))
split_path = '../xlsa17/data/{}/att_splits.mat'.format(dataset)
